...
namespace SistemasVentas.DAL
{
    public class ProveeDal
    {
        ...
        {
            string consulta = "SELECT PROVEE.IDPROVEE, PRODUCTO.NOMBRE AS NOMBREPRODUCTO, PROVEEDOR.NOMBRE AS NOMBREPROVEEDOR, PROVEEDOR.TELEFONO, PROVEE.FECHA, PROVEE.PRECIO " +
